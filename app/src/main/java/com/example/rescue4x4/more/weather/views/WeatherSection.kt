package com.example.rescue4x4.more.weather.views
...
import com.example.rescue4x4.more.weather.Const.Companion.LOADING
import com.example.rescue4x4.more.weather.Const.Companion.NA
import com.example.rescue4x4.more.weather.Utils.Companion.buildIcon
import com.example.rescue4x4.more.weather.Utils.Companion.timeStampToHumanDate
...
fun WeatherSection(weatherResponse: WeatherResult) {
    ...
    */
    ...
    WeatherTitleSection(text = title, subText = subTitle, fontSize = 40.sp)
